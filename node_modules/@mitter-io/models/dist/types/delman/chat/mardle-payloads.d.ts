...
export declare class NewMessagePayload extends MessagingPipelinePayload {
    ...
    constructor(message: Message, channelId: Identifier, globalPipelinePayloadId: string, type: string);
}
export declare class NewMessageTimelineEventPayload extends MessagingPipelinePayload {
    timelineEvent: TimelineEvent;
    messageId: Identifier;
    constructor(timelineEvent: TimelineEvent, messageId: Identifier, globalPipelinePayloadId: string, type: string);
}
...
export declare class ParticipationChangedEventPayload extends MessagingPipelinePayload {
    ...
    channelId: Identifier;
    constructor(oldStatus: ParticipationStatus, newStatus: ParticipationStatus, participantId: string, channelId: Identifier, globalPipelinePayloadId: string, type: string);
}
